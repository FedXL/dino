# модель OpenGVLab/InternViT-300M-448px-V2_5 не заработала
# здесь есть обсуждение этой темы https://github.com/OpenGVLab/InternVL/issues/609
# на август 2025 года решения этой проблемы не найдено  
